...
const CommunityCard = ({ community, isCreator }) => {
    ...
    const joinCommunity = async () => {
        try {
            await axios.put(`http://localhost:3000/communities/${community._id}/join`, { userId: user._id });
    ...
    return (
        <Link to={`/community-page/${community._id}`} className="block bg-gray-800 rounded-md p-4 mb-4 relative">
