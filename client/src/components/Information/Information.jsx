    ...
    <div className="bg-white text-black p-4 rounded-md my-4 mx-4">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        ...
        <div className="bg-gray-200 p-4 rounded-md shadow flex-1 max-w-md">
          ...
          <p className="text-md">
            Explore events and car meets near you. Whether you&apos;re into classic
            cars, sports cars, or just want to check out some cool rides,
            DriveGather has something for everyone.
          </p>
        </div>
      </div>
    </div>
